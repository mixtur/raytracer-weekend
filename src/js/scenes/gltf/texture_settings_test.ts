...
export const create = async (): Promise<Scene> => {
    // const scene = await load_gltf('gltf/TextureSettingsTest/glTF/TextureSettingsTest.gltf', 102400, 1024);
    const scene = await load_gltf_light('gltf/TextureSettingsTest/glTF/TextureSettingsTest.gltf', 128, 64);
